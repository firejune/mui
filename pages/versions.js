...
import VersionsContext from 'src/pages/versions/VersionsContext';
import * as pageProps from 'src/pages/versions/versions.md?@mui/markdown';
...
Page.getInitialProps = async () => {
  ...
  /**
   * @type {import('src/pages/versions/VersionsContext').VersionsContextValue}
   */
  const versions = [];
