...
import generalDocsPages from 'data/docs/pages';
import basePages from 'data/base/pages';
import docsInfraPages from 'data/docs-infra/pages';
import materialPages from 'data/material/pages';
import joyPages from 'data/joy/pages';
...
import { UserLanguageProvider } from 'src/modules/utils/i18n';
  ...
  const productIdentifier = React.useMemo(() => {
    ...
    if (productId === 'joy-ui') {
      return {
        metadata: 'MUI Core',
        name: 'Joy UI',
        versions: [{ text: `v1.0.0`, current: true }],
      };
    }
